...
#         return
#
#     # Only if Playwright page exists
...
#     allure.attach.file(
#         str(screenshot_path),
#         name=f"{item.name}_{status}_screenshot",
...
#     parser.addoption("--base-url", default="https://demo.playwright.dev/todomvc/#/", help="Base URL for tests")
#     # parser.addoption("--video", default="on", help="Record video: on, off, retain-on-failure")
#     parser.addoption("--screenshot", default="on", help="Take screenshot: on, off, only-on-failure")
#     parser.addoption("--tracing", default="on", help="Tracing: on, off, retain-on-failure")
#
#
# # ----------------------------------------------------------------------------
